...
(function() {
  ...
  if ( !i ) {
    setTimeout( function() {
      ...
      console.log( '%cIf you would like to check out this site\'s code, it is available on GitHub: https://github.com/ericwbailey/ericwbailey.design', 'font: 1.25 sans-serif; line-height: 1.7;' );
