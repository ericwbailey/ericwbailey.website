...
excerpt: "An enticing social media preview summary"
date: 2026-04-09
year: 2026
tags:
  - Approach
share:
  facebookDescription: "An attention-grabbing social media preview image."
  twitterDescription: "A generic image placeholder."
eleventyNavigation:
  key: {{ title }}
  parent: {{ year }}
  order: 7
...
1. Communicate a series of instructions the reader should take,
2. In which order they should be followed, and
3. Do so in a way that both makes it easy to follow and also breaks up reading flow to be more noticeable.
...
<img
  ...
  loading="lazy"
  src="{{ '/img/posts/a-compelling-title-that-is-cryptic-enough-to-get-you-to-take-action-on-it/metaphor-image.svg' | url }}" />
